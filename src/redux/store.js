...
//reducer - это чистая функция, которая принимает action, принимает кусок state, который относится к редьюсеру, если нужно применяет этот action к этому стейту и возвращает новый стейт или возвращает стейт, который был не изменённым
